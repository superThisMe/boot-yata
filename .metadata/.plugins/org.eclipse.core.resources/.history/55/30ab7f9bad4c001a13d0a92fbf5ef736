...
public class DashBoardController {
	...
	public String regCar(@RequestParam("carPicture") MultipartFile[] pics, @RequestParam("carManualx") MultipartFile manual, HttpServletRequest req, CarVO car, CarTypeVO carType) {
		
		ArrayList<CarPhotoVO> carPhotos = new ArrayList<CarPhotoVO>();
		
		ServletContext application = req.getServletContext();
		String path = application.getRealPath("/carPics/");
		...
		for(MultipartFile pic : pics) {
			...
			carPhoto.setCarPicture(fileName);
